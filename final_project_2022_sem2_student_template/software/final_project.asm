; C:\FINAL_PROJECT_2022_SEM2_STUDENT_TEMPLATE\SOFTWARE\FINAL_PROJECT.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; Timer8Control = 3;
       move.b    #3,4194622
; Timer8Count += 10;
       add.l     #10,_Timer8Count.L
clock_1:
; }
; return Timer8Count;
       move.l    _Timer8Count.L,D0
       rts
; }
...
; cls();
       jsr       _cls
; drawRect(0,0,screensize.x,screensize.y-1, BORDER);
       pea       35
       move.l    _screensize+4.L,D1
       subq.l    #1,D1
       move.l    D1,-(A7)
       move.l    _screensize.L,-(A7)
       clr.l     -(A7)
       clr.l     -(A7)
       jsr       _drawRect
       add.w     #20,A7
...
; char c ;
; int i, j ;
; char *BugMessage = "Name: Jonathan Zhang, Student Number: 40791428";
       lea       @final_~1_139.L,A0
       move.l    A0,D3
; char *CopyrightMessage = "Copyright (C) PJ Davies 2016";
       lea       @final_~1_140.L,A0
       move.l    A0,-4(A6)
; KillAllBreakPoints() ;
       jsr       _KillAllBreakPoints
...
@final_~1_137:
       dc.b      37,100,0
@final_~1_138:
       dc.b      83,99,111,114,101,58,0
@final_~1_139:
       dc.b      78,97,109,101,58,32,74,111,110,97,116,104,97
       dc.b      110,32,90,104,97,110,103,44,32,83,116,117,100
       dc.b      101,110,116,32,78,117,109,98,101,114,58,32,52
       dc.b      48,55,57,49,52,50,56,0
@final_~1_140:
